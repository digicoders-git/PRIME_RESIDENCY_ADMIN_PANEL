...
const Guests = () => {
  ...
  const [guests, setGuests] = useState([
    { id: 'GST-001', name: 'John Doe', email: 'john@example.com', phone: '+91 98765 43210', lastVisit: '2024-01-15', totalBookings: 15, status: 'VIP', joinedDate: '2023-05-12' },
    { id: 'GST-002', name: 'Jane Smith', email: 'jane@example.com', phone: '+91 87654 32109', lastVisit: '2024-01-10', totalBookings: 2, status: 'Regular', joinedDate: '2023-11-20' },
    { id: 'GST-003', name: 'Mike Johnson', email: 'mike@example.com', phone: '+91 76543 21098', lastVisit: '2024-01-08', totalBookings: 8, status: 'VIP', joinedDate: '2023-06-15' },
    { id: 'GST-004', name: 'Sarah Wilson', email: 'sarah@example.com', phone: '+91 65432 10987', lastVisit: '2024-01-05', totalBookings: 1, status: 'New', joinedDate: '2024-01-01' },
    { id: 'GST-005', name: 'Robert Brown', email: 'robert@hotmail.com', phone: '+91 99887 76655', lastVisit: '2023-12-28', totalBookings: 4, status: 'Regular', joinedDate: '2023-08-10' },
    { id: 'GST-006', name: 'Emma Davis', email: 'emma@gmail.com', phone: '+91 91234 56789', lastVisit: '2024-01-20', totalBookings: 12, status: 'VIP', joinedDate: '2023-02-14' },
  ]);
